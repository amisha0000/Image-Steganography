...
def encrypt(): 
    ...
    img1 = cv2.resize(img1, (650,650))
    img2 = cv2.resize(img2, (650,650))
      
    for i in range(img2.shape[0]):    # to iterate through rows hence [0]
    ...
    for i in range(width): 
        for j in range(height): 
            for l in range(3): 
                ...
                v2 = v1[:4] + chr(random.randint(0, 1)+48) * 4  #randomly assign 0 & 1, ascii 48 = 0, *4 to print it 4 times in the pixel
